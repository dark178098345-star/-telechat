...
assert.match(html,/profile-background-v84\.css\?v=85/);
assert.match(html,/profile-background-v84\.js\?v=85/);
...
assert.match(worker,/profile-background-v84\.css\?v=85/);
assert.match(worker,/profile-background-v84\.js\?v=85/);
