...
assert.match(html,/background-presence-v101\.css\?v=101/);assert.match(html,/background-presence-v101\.js\?v=105/);
...
assert.match(worker,/background-presence-v101\.css\?v=101/);assert.match(worker,/background-presence-v101\.js\?v=105/);
