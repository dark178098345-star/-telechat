...
for(const asset of ['presence-model-v120.js?v=129','presence-v120.js?v=129','smooth-ui-v76.js?v=133','chat-speed-v51.js?v=134']){assert.ok(index.includes(asset));assert.ok(sw.includes(asset));}
