...
for(const asset of ['presence-model-v120.js?v=120','presence-v120.js?v=120','smooth-ui-v76.js?v=120','chat-speed-v51.js?v=124']){assert.ok(index.includes(asset));assert.ok(sw.includes(asset));}
