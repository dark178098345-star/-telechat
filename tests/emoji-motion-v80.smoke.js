...
assert.match(html,/emoji-motion-v80\.css\?v=81/);
assert.match(html,/emoji-motion-v80\.js\?v=81/);
assert.ok(html.indexOf('emoji-motion-v80.css?v=81')>html.indexOf('mobile-experience-v79.css?v=79'));
assert.ok(html.indexOf('emoji-motion-v80.js?v=81')>html.indexOf('mobile-experience-v79.js?v=79'));
assert.match(css,/v80-button-ripple/);
assert.match(css,/button\.v80-ripple-host\{position:relative\}/);
assert.match(css,/\.chat-more-v52\.v80-motion-ready\{translate:0!important/);
...
assert.match(js,/getComputedStyle\(button\)\.position==='static'/);
