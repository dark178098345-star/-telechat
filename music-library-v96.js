...
(() => {
  ...
  function ensureDialog() {
    ...
    dialog.querySelector('.music-add-details-v98').addEventListener('toggle', event => {
      event.currentTarget.classList.toggle('is-expanded-v98', event.currentTarget.open);
      position();
    });
