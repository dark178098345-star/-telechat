-- tele.chat — безлимитные лимитированные подарки для creator v28
-- Запусти файл целиком один раз в Supabase SQL Editor.
-- Для остальных пользователей сохраняется пауза 21 день.
...
begin
  ...
  -- Creator может отправлять сколько угодно лимитированных подарков.
